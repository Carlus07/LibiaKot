...
?>
			...
			<div class="col-sm-12 text-center">
				<nav aria-label="Page navigation example">
				  <ul class="pagination">
				    <li class="page-item">
				      <a class="page-link" href="?p=housing.request&r=<?php echo ($active == 1) ? 12 : (($active-1)*12); ?>" aria-label="Previous">
				    ...
				    <?php 
				    	for($i = 1; $i <= $pagination; $i++)
				    	{
				    		...
				    		$redirection = $i*12;
				    		echo '<li class="page-item '.$class.'"><a class="page-link" href="?p=housing.request&r='.$redirection.'">'.$i.'</a></li>';
				    	}
				 	?>
				    <li class="page-item">
				      <a class="page-link" href="?p=housing.request&r=<?php echo ($active == $pagination) ? ($active*12) : (($active+1)*12); ?>" aria-label="Next">
